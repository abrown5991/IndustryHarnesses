"""Invoke the deployed Plant-Ops harness.

Usage:
  RUNTIME_ARN=arn:aws:bedrock-agentcore:us-west-2:<acct>:runtime/<name>-<suffix> \
  uv run invoke_agent.py "What's the OEE on BODY-2 this shift and top defect causes?"
"""
...
prompt = (
    sys.argv[1]
    if len(sys.argv) > 1
    else "Give me a plant status summary for line BODY-2 this shift."
)
