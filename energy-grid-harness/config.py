...
# Primary model: complex reasoning (outage RCA, load-balancing analysis).
...
# Fast/cheap model tier: routine lookups and summaries.
# TODO(verify): confirm exact Bedrock model/inference-profile ID for your region.
...
# Sampling / generation controls. Grid ops favors low temperature for
...
KB_S3_BUCKET = os.getenv("KB_S3_BUCKET", "energy-grid-harness-kb-docs")
