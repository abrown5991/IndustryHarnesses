...
Usage:
  CONTAINER_URI=<acct>.dkr.ecr.us-west-2.amazonaws.com/energy-grid-harness:latest \
  EXECUTION_ROLE_ARN=arn:aws:iam::<acct>:role/EnergyGridHarnessRuntimeRole \
...
RUNTIME_NAME = os.environ.get("RUNTIME_NAME", "energy_grid_harness")
