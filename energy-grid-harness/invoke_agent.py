"""Invoke the deployed Grid-Ops harness.

Usage:
  RUNTIME_ARN=arn:aws:bedrock-agentcore:us-west-2:<acct>:runtime/<name>-<suffix> \
  uv run invoke_agent.py "What's the load forecast for NORTH-3 over the next 12 hours?"
"""
...
prompt = sys.argv[1] if len(sys.argv) > 1 else "Give me a grid status summary for NORTH-3."
