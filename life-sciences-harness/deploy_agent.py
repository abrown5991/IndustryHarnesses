...
Usage:
  CONTAINER_URI=<acct>.dkr.ecr.us-west-2.amazonaws.com/life-sciences-harness:latest \
  EXECUTION_ROLE_ARN=arn:aws:iam::<acct>:role/LifeSciencesHarnessRuntimeRole \
...
RUNTIME_NAME = os.environ.get("RUNTIME_NAME", "life_sciences_harness")
